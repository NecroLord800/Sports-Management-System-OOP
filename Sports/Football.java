...
public class Football {
    ...
    public Football() {
        this.frame = new CustomFrame("Football", 500, 450);
        ...
        button1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Teams teamsFrame = new Teams("football", "./Database/football_team.txt");
        ...
        button2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                frame.setVisible(false);
                Schedule schedule = new Schedule("./Database/football_schedule.txt");
