...
public class Volleyball {
    ...
    public Volleyball() {
        this.frame = new CustomFrame("Volleyball", 500, 450);
        ...
        button1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Teams teamsFrame = new Teams("volleyball", "./Database/volleyball_team.txt");
        ...
        button2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                frame.setVisible(false);
                Schedule schedule = new Schedule("./Database/volleyball_schedule.txt");
