...
public class Basketball {
    ...
    public Basketball() {
        this.frame = new CustomFrame("Basketball", 500, 450);
        ...
        button1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Teams teamsFrame = new Teams("basketball", "./Database/basketball_team.txt");
        ...
        button2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                frame.setVisible(false);
                Schedule schedule = new Schedule("./Database/basketball_schedule.txt");
